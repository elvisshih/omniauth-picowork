...
module OmniAuth
  module Strategies
    class TlDev < OmniAuth::Strategies::OAuth2
      ...
      option :client_options, {
        :site => "https://dev.ihandy.cn",
        :authorize_url => "https://dev.ihandy.cn/uAuth/oauth2/authorize",
        :token_url => "https://dev.ihandy.cn/uAuth/oauth2/token"
      }
...
OmniAuth.config.add_camelization 'tldev', 'TlDev'
